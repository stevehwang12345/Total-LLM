...
from total_llm.config.model_config import get_llm_model_name, get_llm_base_url
...
async def get_encryption_status():
    ...
    - 암호화 방식 정보
    """
    from total_llm.services.control.credential_manager import get_credential_manager
...
async def assign_device_to_zone(device_id: str, request: DeviceZoneAssignRequest):
    ...
    try:
        ...
        # 감사 로깅
        from total_llm.services.control.audit_logger import get_audit_logger
